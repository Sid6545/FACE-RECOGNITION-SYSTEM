...
class Student:
    def __init__(self,root):
        ...
        #first_img
        img=Image.open(r"C:\Users\ASUS\Desktop\Face Recogonization System\college_photos\facescanner.jpg")
        ...
        #second_img
        img1=Image.open(r"C:\Users\ASUS\Desktop\Face Recogonization System\college_photos\studentslife.jpg")
        ...
        #third_img
        img2=Image.open(r"C:\Users\ASUS\Desktop\Face Recogonization System\college_photos\studentsty.jpg")
        ...
        f_lbl.place(x=1000,y=0,width=550,height=130)
         ...
         #background_img
        img3=Image.open(r"C:\Users\ASUS\Desktop\Face Recogonization System\college_photos\background2.jpg")
        img3=img3.resize((1920,1080),Image.ADAPTIVE)
        ...
        main_frame.place(x=10,y=55,width=1500,height=810)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=810,height=810)

        img_left=Image.open(r"C:\Users\ASUS\Desktop\Face Recogonization System\college_photos\stud3.jpg")
        img_left=img_left.resize((810,130),Image.ADAPTIVE)
        ...
        current_course_frame.place(x=5,y=135,width=800,height=150)
        ...
        course_combo["values"]=("Select Course","BTECH","BSC","BCA","BE")
        ...
        class_student_frame.place(x=5,y=250,width=800,height=335)
        ...
        #Gender
        gend_label=Label(class_student_frame,text="Gender:",font=("times new roman",13,"bold"),bg="white")
        gend_label.grid(row=2,column=0,padx=10,pady=10,sticky=W)
        
        gend_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,font=("times new roman",12,"bold"),state="readonly",width=20)
        gend_combo["values"]=("Male","Female","Other")
        gend_combo.current(0)
        gend_combo.grid(row=2,column=1,padx=2,pady=10,sticky=W)
        ...
        #Phone
        ph_label=Label(class_student_frame,text="Phone No:",font=("times new roman",13,"bold"),bg="white")
        ph_label.grid(row=3,column=2,padx=10,pady=10,sticky=W)

        ph_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone,width=20,font=("times new roman",12,"bold"))
        ph_entry.grid(row=3,column=3,padx=10,pady=5,sticky=W)

         #Address
        add_label=Label(class_student_frame,text="Addres:",font=("times new roman",13,"bold"),bg="white")
        add_label.grid(row=4,column=0,padx=10,pady=10,sticky=W)
        ...
        #Teacher name
        tn_label=Label(class_student_frame,text="Teacher Name:",font=("times new roman",13,"bold"),bg="white")
        tn_label.grid(row=4,column=2,padx=10,pady=10,sticky=W)

        tn_entry=ttk.Entry(class_student_frame,textvariable=self.var_teacher,width=20,font=("times new roman",12,"bold"))
        ...
        btn_frame.place(x=0,y=245,width=795,height=90)
        ...
        #delete button
        del_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=19,font=("times new roman",13,"bold"),bg="blue",fg="white")
        del_btn.grid(row=0,column=2)

        #reset button
        res_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=19,font=("times new roman",13,"bold"),bg="blue",fg="white")
        res_btn.grid(row=0,column=3)
        btn_frame1=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=280,width=795,height=70)

        tps_btn=Button(btn_frame1,text="Take photo sample",command=self.generate_data_set,width=39,font=("times new roman",13,"bold"),bg="blue",fg="white")
        tps_btn.grid(row=0,column=0)


        upp_btn=Button(btn_frame1,text="Update photo sample",width=39,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\ASUS\Desktop\Face Recogonization System\college_photos\student.jpeg")
        img_right=img_right.resize((810,130),Image.ADAPTIVE)
        ...
        search_entry=ttk.Entry(search_frame,width=21,font=("times new roman",12,"bold"))
        ...
        self.student_table.heading("roll",text="Rollnum")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Pass@1234",database="sys")
