...
class Face_recognition:
    def __init__(self,root):
        ...
        #first img
        img_top=Image.open(r"college_photos\facerec2.jpeg")
        ...
        #secong img
        img_bottom=Image.open(r"college_photos\facerec1.jpg")
        ...
        #=========================================ATTENDENCE=================================
    def mark_atten(self):
        with open("shagun.csv","r+",newline="\n") as f:
